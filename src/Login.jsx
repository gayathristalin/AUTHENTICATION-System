    ...
    <div class="login_body">
      ...
      <login_extras>
        <div class="header">
          ...
          <h1 class="login_text">AI HEALTH CHATBOT</h1>
        </div>
        <div class="login_chatbot_svg">
          ...
          >
            ...
            <path
              ...
              fill="#3f3d56"
            />
            <circle cx="496.72182" cy="248.80992" r="5.24444" fill="#f2f2f2" />
            <circle cx="513.76626" cy="248.80992" r="5.24444" fill="#f2f2f2" />
            <circle cx="530.81071" cy="248.80992" r="5.24444" fill="#c97b9e" />
            <path
            ...
            <path
              ...
              fill="#fff"
            />
            <circle cx="161.57649" cy="35" r="31" fill="#2f2e41" />
            <path
            ...
            <path
              ...
              fill="#2f2e41"
            />
            <circle cx="173.89145" cy="41.29134" r="24.56103" fill="#ffb8b8" />
            <path
            ...
            <path
              ...
              fill="#2f2e41"
            />
            <circle cx="135.57649" cy="20" r="20" fill="#2f2e41" />
            <path
              id="a5b0fbf6-85a2-48e8-ad40-c81376cd9893-284"
              data-name="Path 22"
            ...
            />
            <path
              id="a5d1dbd7-b3f0-4599-af89-34309e57a462-285"
              data-name="Path 23"
              ...
              fill="#fff"
            />
            <circle cx="279.26626" cy="153.30992" r="11" fill="#c97b9e" />
            <path
